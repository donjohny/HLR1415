...
freeMatrices (void)
{
  free (M);			/* eigentlicher Bereich für Werte in den Matrizen */
  if (Matrix[0] != 0)
    free (Matrix[0]);		/* Zeiger auf die erste Matrix */
  if (Matrix[1] != 0)
    free (Matrix[1]);		/* Zeiger auf die zweite Matrix */
  free (Matrix);		/* Zeiger auf die Zeiger auf die Matrizen */
}
